...
public class SearchActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText button_search1 = (EditText) findViewById(R.id.button_search1);
        button_search1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MovieDBThread movieDBThread = new MovieDBThread(SearchActivity.this, "https://api.themoviedb.org/3/search/movie?language=en-US&query=" + button_search1.getText(), "search");
